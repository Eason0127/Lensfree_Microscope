...
According to Shannon sampling criteria, if a signal can be recovered completely and without any errors, the sampling frequency must be higher than at least two times of the maximum frequency of the signal. The maximum frequency of the signal in our system can be easily calculated.
